...
public class Customer {
    ...
    private String customer_username; // Added
    private String referral_code;     // Added
    ...
    public Customer(int customer_id, String first_name, String last_name, String gender,
                    ...
                    String customer_username, String referral_code, Timestamp created_at) { // Updated
        ...
        this.customer_username = customer_username; // Added
        this.referral_code = referral_code;           // Added
    ...
    public String getCustomer_username() { return customer_username; } // Added
    public String getReferral_code() { return referral_code; }           // Added
